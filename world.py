...
class env(object):
    def __init__(self):
        ...
        self.gui = gui.gui()
        self.plan = ['pick','object1','back','object1']#, 'back', 'put'] #simple plan, can be modified for future purpose
    ...
    def executePlan(self):
        ...
        self.action_status = self.gui.executeAction(self.gripper, self.cur_action, self.target_name)
